...
parser.add_argument('--concurrent_scans_retries', default=0,
                    help='Retry the call this many times if your subscription hits the concurrent scans limit. (Default = 0)')
parser.add_argument('--concurrent_scans_retry_delay', default=0,
                    help='Delay in seconds between retrying when subscription hits the concurrent scans limit. (Default = 0)')
...
for app in apps_to_scan:
    ...
    response = qgc.request(query_uri, data, concurrent_scans_retries=c_args.concurrent_scans_retries, concurrent_scans_retry_delay=c_args.concurrent_scans_retry_delay)
    print 'Done:'
